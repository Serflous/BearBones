...
int Objects::ResourceLoader::LoadToVAO(std::vector<float> positions, std::vector<float> textureCoords, std::vector<float> normals, std::vector<int> indicies)
{
	GLuint vaoId = 0;
...
void Objects::ResourceLoader::AddDataToVAO(int attribList, int coordSize, std::vector<float> data)
{
	GLuint vboId = 0;
